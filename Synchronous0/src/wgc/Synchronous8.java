...
class Log3
{
    ...
    String fileList = "";
    boolean flog = false;
    public Log3(String filePath , String fileList , boolean flog)
    {
...
//        		   String content = "account=" + URLEncoder.encode(file.toString() , "UTF-8");
//        		   content += "&pswd=" + URLEncoder.encode(bufferedOutputStream , "UTF-8");
...
class UI3 extends Thread
{
    String deal1 = "";
    String deal2 = "";
    public UI3(String deal1 , String deal2)
    {
        this.deal1 = deal1;
        this.deal2 = deal2;
    }
