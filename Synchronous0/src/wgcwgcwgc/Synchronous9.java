 ...
 * @file_name        Synchronous9.java
 * @type_name        Synchronous9
 * @enclosing_type   
 * @tags             
 * @todo             
 * @others           
...
public class Synchronous9
{
	public static void main(String [] args)
	{
		...
		while(true)
		{
			...
			try
			{
				ReadIniFile9 readIniFile = new ReadIniFile9("../config/wgc.ini");
...
class ReadIniFile9
{
	...
	public ReadIniFile9(String filename)
	{
...
class UI9 extends Thread
{
	public void run()
	{
		...
		{
			Upload9 upload = new Upload9();
			upload.setIsrunning(false);
			System.out.println("正在结束，请稍候，，，\n");
			GetFilesList9 getFilesList = new GetFilesList9();
...
class Upload9 extends Thread
{
	...
	public void run()
	{
		new GetFilesList9(filepath).getFilesName(filepath);
		ReadIniFile9 readIniFile = new ReadIniFile9("../config/wgc.ini");
		...
		try
		{
					...
					&& ( tempString = bufferedReader.readLine() ) != null)
			{
				try
				{
					...
					ffkvp.add(new FormFieldKeyValuePair9(filepaths , tempString));
...
class HttpPostEmulator9
{
	...
	public String sendHttpPostRequest(String serverUrl ,
			ArrayList <FormFieldKeyValuePair9> generalFormFields ,
